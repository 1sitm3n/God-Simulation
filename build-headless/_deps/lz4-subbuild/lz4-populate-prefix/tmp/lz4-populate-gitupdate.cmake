...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "v1.9.4"
  WORKING_DIRECTORY "/Users/mehmetisitmen/dev/God-Simulation/build-headless/_deps/lz4-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/mehmetisitmen/dev/God-Simulation/build-headless/_deps/lz4-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/mehmetisitmen/dev/God-Simulation/build-headless/_deps/lz4-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
